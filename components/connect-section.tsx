...
const contactLinks = [
  {
    name: "LinkedIn",
    icon: Linkedin,
    href: "https://linkedin.com/in/geraldine-makaza",
  ...
  },
  {
    name: "GitHub",
    icon: Github,
    href: "https://github.com/geraldine-makaza",
  ...
  },
  {
    name: "Email",
    icon: Mail,
    href: "mailto:geraldine.makaza@example.com",
    label: "geraldine.makaza@example.com",
